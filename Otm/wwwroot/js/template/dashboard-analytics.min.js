! function (o, e) {
    ...
    }, 2e3), e("#task-card input:checkbox").each(function () {
        t(this)
    ...
    setInterval(function () {
        var o = Math.round(Math.random() * (i.labels.length - 1));
        void 0 !== a && (i.datasets[0].data[o] && (i.datasets[0].data[o] = Math.round(100 * Math.random())), i.datasets[1].data[o] && (i.datasets[1].data[o] = Math.round(100 * Math.random())), a.update())
    }, 2e3);
    var l, n = {
        type: "line",
        options: {
    ...
    setInterval(function () {
        if (void 0 !== l) {
            ...
            p.datasets[0].data.shift(), p.datasets[0].data.push([o]), l.update()
        }
    }, 2e3);
    var h, c = {
        type: "bar",
